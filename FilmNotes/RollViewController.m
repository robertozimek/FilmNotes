...
-(void)clearFields
{
    self.focalLengthTextField.text = nil;
    self.apertureTextField.text = nil;
    self.shutterSpeedTextField.text = nil;
...
{
    self.rollKey = [NSString stringWithFormat:@"RollNumber %@",RollNumber];
