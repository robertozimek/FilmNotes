...
- (void)showInView:(UIView *)view
{
    ...
    for (NSArray *block in _blocks)
    {
        ...
        button.backgroundColor = [UIColor colorWithRed:0.09 green:0.09 blue:0.09 alpha:1.0];
        button.tag = i++;
    ...
    _view.backgroundColor = [UIColor colorWithRed:0.91 green:0.91 blue:0.91 alpha:1.0];
